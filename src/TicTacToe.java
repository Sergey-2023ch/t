public class TicTacToe {
    ...
    String makeMove(int x, int y) {
        ...
        check = checkGame();
        if (check != null) {
            if (check.equals("X")) return "Game was ended. Player X won";
            else if (check.equals("0")) return "Game was ended. Player 0 won";
            else return "Game was ended. Draw";
        }
    ...
    String checkGame() {
        ...
        if (check) return "X";
            ...
            check = true;
            for (int i = 0; i < 3; i++) {
                if (diagonal1[i].equals("X") || diagonal1[i].equals("-")) {
                    check = false;
                }
            }
            if (check) return "0";
